 ...
 * @author nikollace
 */
public class ObrisiPregled extends GenerickaOperacija{
    ...
    protected void izvrsiOperaciju(Object param) throws CRUDException {
        //repository.delete((StavkaPregleda)((Pregled)param).getStavkePregleda().get(0));
        for (StavkaPregleda stavkaPregleda : ((Pregled)param).getStavkePregleda()) {
            repository.obrisi(stavkaPregleda);
        }
        repository.obrisi((Pregled)param);
    }
